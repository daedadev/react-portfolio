...
export const projectData: IProjectProps[] = [
    ...
    },
    {
      ...
      challenges: "Main difficulty with this project was parsing the data and mapping it in a way that is presentable and modular.",
      triumphs: "Being able to create a webpage with similar conventions as StockX is a huge accomplishment. The preloading and inline search results really mimic their websites feel.",
      dependancies: [
        "Javascript",
        "React",
        "HTML",
